...
const TEAMS: TeamData[] = [
  {
    ...
    tasks: [
      ...
      'זיהוי תושב באפליקציית מודיעין אוכלוסיה',
      'הפנייה למס"ר',
  ...
  {
    id: 'hotels',
    title: 'צוות קליטה בבתי מלון',
    subtitle: 'ליווי משפחות בתהליך הקליטה בבית מלון',
    icon: Hotel,
    ...
    iconBg: 'bg-teal-100',
    tasks: [
      'ליווי משפחות בתהליך הקליטה בבית מלון',
      'איסוף צרכים',
      'העברת נתונים למטה המכלול',
    ],
  ...
  },
  {
    id: 'emotional',
    title: 'צוות קו פתוח',
    subtitle: 'מענה טלפוני לתושבים במצוקה',
    icon: Phone,
  ...
  },
  {
    ...
    tasks: [
      ...
      'פתיחת חמ"ל לוגיסטיקה עבור מענה לצרכים חומריים מיידיים (ביגוד, מזון תינוקות וכו׳)',
    ],
    ...
    <div className="max-w-5xl mx-auto px-6 py-10 space-y-10">
      ...
      <section className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
          {[
            { name: 'רותי גור', role: 'ראש מטה (א׳)' },
            { name: 'לימור איצקוביץ', role: 'ראש מטה (ב׳)' },
            { name: 'יניר יעקובי', role: 'רכז חירום' },
            { name: 'נדין שם טוב', role: 'ראש מטה התערבות' },
            { name: 'יעל קידר', role: 'מנהלת מס"ר' },
            { name: 'סיגל קני פז', role: 'ראש מטה רגשי' },
            { name: 'מוקד 106', role: 'מוקד עירוני' },
          ].map((c, i) => {
            const phone = getPhone('teams', c.name);
