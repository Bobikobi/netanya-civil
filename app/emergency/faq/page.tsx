...
const FAQ_CATEGORIES: FAQCategory[] = [
  {
    ...
    questions: [
      ...
      { q: 'מי אחראי על תפעול המערכת?', a: 'הרשות המקומית – בדרך כלל דרך מכלול אוכלוסייה ומנהל השירותים החברתיים. יש גורמי מטה ארציים שמלווים את התהליך.' },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: 'מי מנהל את מכלול אוכלוסייה?', a: 'מנהל מנהל השירותים החברתיים, או בעל תפקיד שמונה מראש.' },
